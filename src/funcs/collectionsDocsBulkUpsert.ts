 ...
 */
export function collectionsDocsBulkUpsert(
  client: LambdaDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.BulkUpsertDocsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/collections/{collectionName}/docs/bulk-upsert")(
    pathParams,
  );
