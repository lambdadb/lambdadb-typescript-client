 ...
 */
export function collectionsGetCollection(
  client: LambdaDBCore,
  request: operations.GetCollectionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetCollectionResponse,
...
> {
  ...
  const path = pathToFunc("/collections/{collectionName}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCollectionResponse$inboundSchema),
